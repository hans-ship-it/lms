    ...
    <style>
        ...
        * {
        ...
        @media screen and (max-width: 768px) {
            ...
            /* Tighter paper on mobile â€” maximize visible width */
            .paper {
                margin: 0.5rem;
            ...
            /* Summary box: stay in a row on mobile â€” no stacking */
            .summary-box {
                padding: 1rem 0.5rem;
                gap: 0;
                flex-direction: row;
...
<body>
    ...
    <div class="paper">
        ...
        <?php else: ?>
            ...
            <p class="keterangan">A &ge; 90 (Sangat Baik) &nbsp;|&nbsp; B = 80â€“89 (Baik) &nbsp;|&nbsp; C = 70â€“79 (Cukup)
                &nbsp;|&nbsp; D &lt; 70 (Kurang)</p>
