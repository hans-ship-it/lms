...
// â”€â”€ Query SEMUA tugas yang ditujukan ke kelas siswa â”€â”€
...
function getStatus($row) {
    if ($row['submission_id'] === null) {
        ...
        if ($past_deadline) {
            return ['label' => 'Tidak Dikumpulkan', 'color' => '#b91c1c', 'bg' => '#fee2e2', 'icon' => 'âœ•'];
        }
        return ['label' => 'Belum Dikumpulkan', 'color' => '#b45309', 'bg' => '#fef3c7', 'icon' => 'â³'];
    }
    if ($row['grade'] === null) {
        return ['label' => 'Menunggu Penilaian', 'color' => '#1d4ed8', 'bg' => '#dbeafe', 'icon' => 'â³'];
    }
    return ['label' => 'Dinilai', 'color' => '#15803d', 'bg' => '#dcfce7', 'icon' => 'âœ“'];
}
...
<head>
    ...
    <title>Keaktifan Siswa â€“ <?php echo htmlspecialchars($student_name); ?></title>
...
<div class="content">
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <div class="stat-value" style="color:<?php echo $avg_info['color']; ?>;">
                    <?php echo $total_dinilai > 0 ? number_format($avg_nilai, 1) : 'â€”'; ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-card">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; font-size:0.78rem; color:var(--text-muted);">
                            <?php echo $task['deadline'] ? date('d/m/Y', strtotime($task['deadline'])) : 'â€”'; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php endforeach; ?>
        ...
        <div class="legend">
            <strong>Predikat:</strong> A â‰¥ 90 &nbsp;|&nbsp; B = 80â€“89 &nbsp;|&nbsp; C = 70â€“79 &nbsp;|&nbsp; D &lt; 70
            &nbsp;&nbsp;â€¢&nbsp;&nbsp;
            <strong>Status:</strong>
            <span style="color:#15803d;">âœ“ Dinilai</span> &nbsp;|&nbsp;
            <span style="color:#1d4ed8;">â³ Menunggu Penilaian</span> &nbsp;|&nbsp;
            <span style="color:#b45309;">â³ Belum Dikumpulkan</span> &nbsp;|&nbsp;
            <span style="color:#b91c1c;">âœ• Tidak Dikumpulkan</span>
        </div>
        <?php endif; ?>
    </div>
