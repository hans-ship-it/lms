...
// Determine assignment with most ungraded (or just the oldest one) â€” exclude attendance
$stmt = $pdo->prepare("
...
<head>
    ...
    <style>
        ...
        /* â”€â”€â”€ Hero guru: biru (selaras modul global, beda dari teal siswa) â”€â”€â”€ */
        .db-hero {
            position: relative;
...
?>
            ...
            <div class="db-alert">
                ...
                <?php if ($priority_assignment_id): ?>
                    <a href="view_submissions.php?assignment_id=<?php echo $priority_assignment_id; ?>">Nilai Sekarang â†’</a>
                <?php
    else: ?>
                    <a href="kelas.php">Lihat Kelas â†’</a>
                <?php
    endif; ?>
            </div>
            <?php
...
?>
    ...
    endforeach; ?>
                        <?php if ($my_classes_count > 5): ?>
                            <a href="kelas.php" class="view-all-link">Lihat Semua Kelas â†’</a>
                        <?php
    endif; ?>
                    <?php
endif; ?>
